...
const choices = [
    ...
    },
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'c\'est un message crypté il a l\'air important.',
    ...
    //Une réparation nécessaire
    {
        ...
        required_stat: 'intelligence',
        required_value: 70,
        result: 'Vous avez réparé la station, sur les écrans un message d\'alerte s\'affiche',
        effect_intelligence: 15,
        effect_luck: 10,
        effect_dexterity: 5,
    ...
    {
        scenarioId: 31,
        description: 'Tenter de déplacer la station derrière une planète pour se proteger',
        required_stat: 'dexterity',
        required_value: 80,
        result: 'Vous réussissez assez rapidement à vous cacher derrière une planète.',
        effect_intelligence: 15,
        effect_luck: 5,
    ...
    },
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Vous réussissez pas assez rapidement à vous cacher derrière une planète.',
        effect_intelligence: 15,
        effect_life: -999,
        effect_dexterity: 5,
    ...
    {
        scenarioId: 32,
        description: 'Atterrir sur la planète',
        required_stat: '',
        required_value: 0,
    ...
    {
        scenarioId: 29,
        description: 'Tu décides d\'aller voir ce qui bouge',
        required_stat: '',
        required_value: 0,
...

    {
        ...
        required_value: 70,
        effect_life: -9999,
        result: 'L\'alien etant trop lourd tu ne ne réussis pas à fuir assez vite.',
    ...
    {
        scenarioId: 34,
        description: 'Tu ne prends pas l\'alien tu le laisse mourir et tu t\'enfuis',
        required_stat: '',
        required_value: 0,
    ...
    //Le message
    {
        ...
        required_value: 50,
        result: 'Le message te mène à une zone sécurisée de la station où tu trouves un capsule de sauvetage.',
        effect_charisma: 5,
        effect_life: 15,
        nextScenarioId: 9,         // Choisir une direction
    },
...

    {
        ...
        required_stat: 'charisma',
        required_value: 70,
        result: 'Vous communiquer parfaitement avec les aliens, ils arrivent vous aider !',
        effect_courage: 15,
        effect_luck: 15,
        effect_charisma: 20,
        nextScenarioId: 27,         //Une nouvelle vie
    ...
    {
        scenarioId: 19,
        description: 'Vous ne parlez pas alien mais essayez quand même',
        required_stat: 'intelligence',
        required_value: 70,
        result: 'Vous parlez difficilement avec les aliens mais ils semblent comprendre, ils arrivent vous aider !',
        effect_intelligence: 15,
        effect_life: -5,
    ...
    },
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Vous laissez un VU au aliens, pas sur qu\'ils aiment ca ...',
        effect_intelligence: -15,
        effect_life: -999,
    ...
    {
        scenarioId: 16,
        description: 'Déposez-moi sur la terre !',
        required_stat: 'Luck',
        required_value: 80,
        result: 'Une chance un traducteur est à bord ils vous ont parfaitement compris !',
        effect_luck: +100,
    ...
    },
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Malgré votre quinte de toux les aliens arrivent à vous comprendre parfaitement !',
        effect_intelligence: -15,
        effect_life: -15,
...

    {
        ...
        required_stat: 'Luck',
        required_value: 70,
        result: 'Par chance la Terre a un antidote vous êtes sauvé et la Terre aussi',
        effect_luck: +100,
        nextScenarioId: 23,         //Home sweet Home
    },
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Malheureusement la terre n\'avais pas de solution vous avez contracté une maladie trop dangereuse, vous etes responsable de l\'extinction de l\'humanité',
        effect_charisma: 10,
        nextScenarioId: 15,         //Le retour sur Terre
    },
    ...
    //Une nouvelle vie
    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Vous choisissez une carrière politique dans laquelle vous évoluerez progressivement afin de devenir l\'embassadeur de toutes les espèce !',
        effect_intelligence: 15,
        effect_life: -5,
    ...
    {
        scenarioId: 27,
        description: 'Faire prosperer le réarmement démographique Alien',
        required_stat: '',
        required_value: 0,
...

    {
        ...
        required_stat: 'intelligence',
        required_value: 70,
        result: 'Les aliens decident de tirer sur vous, car votre maman ne ne vous a pas appris la politesse',
        effect_life: -999,
...

    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'j\'ai l\'impression que ça va être long',
        effect_life: -999,
        effect_luck: -999,
...

    {
        ...
        required_stat: 'intelligence',
        required_value: 45,
        result: 'Vous trouvez un pistolet et une boite de soin. vous sentez une présence derrière vous',
        effect_dexterity: 85,
        effect_life: 15,
        nextScenarioId: 5,         // //L\'attaque des créatures de l\'ombre
    },
...

    {
        ...
        required_stat: 'dexterity',
        required_value: 20,
        result: 'Vous perdez ils vous ont tué.',
        effect_life: -999,
    ...
    },
    {
        ...
        required_stat: 'dexterity',
        required_value: 150,
        result: 'Une fois les créatures combattues les créatures, vous vous dirigez vers le poste de pilotage du vaisseau.',
        effect_dexterity: 85,
        effect_life: -10,
        effect_luck: 10,
...

    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Une fois le trou de ver traversé vous tomber face a une planete aux allures familières.',
        nextScenarioId: 15,         // Le retour sur Terre
    },
    {
        scenarioId: 13,
        ...
        required_stat: '',
        required_value: 0,
        result: 'Après etre sorti du trou de ver tu te retrouve face à une immense planète aux allures étranges..',
    ...
    {
        scenarioId: 15,
        description: 'Rentrez à la maison !',
        required_stat: '',
        required_value: 0,
...

    {
        ...
        required_stat: '',
        required_value: 0,
        result: 'Tu vis ta meilleure vie avec tes nouveaux amis les clones.',
